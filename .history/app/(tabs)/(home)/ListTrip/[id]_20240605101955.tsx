    ...
    <View>
      ...
      <View
        ...
        <View style={{padding: 5}}>
          ...
          <Text>
            Description: FTravelBus là một doanh nghiệp uy tín, thành công và có
            đóng góp quan trọng trong ngành vận tải Việt Nam.
          </Text>
          <Text style={{fontSize: 16, fontWeight: 'bold'}}>Available Seat</Text>
